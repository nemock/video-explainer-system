...
URLs: book = `http://davesaunders.net/book` · The Build = `https://davesaunders.net/free-trial`. **The Build's exact price/bonus figures live in the private FWF config** and go in the **YouTube description**, not the spoken/on-screen interstitial (evergreen copy only, e.g. "start your free trial — link below"), so an offer change never strands an immutable master.
